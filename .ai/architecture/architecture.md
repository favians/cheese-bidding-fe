...
### Remaining
- admin players V1 parity polish: status filter, pagination, password reset flow, character/detail management, and V1-like styling with CSS classes.
